// ==UserScript==
// @name         Agar.io Ultimouse
// @namespace    AgarUltiMouse
// @version      2.1
// @description  Agar.io ultimate mouse control+. Left 1x split, middle infinite split, right infinite feed
// @author       randajan
// @match        http://agar.io
// @grant        none
...
var auc = {
    ...
    control:{
        ...
        a: [],
        o: [
            {code:"Key32", name:"Space", act:true, count:1, rate:10, edit:0},
            {code:"Key87", name:"KeyW", act:false, count:1, rate:10, edit:0},
            {code:"Mouse1", name:"Mouse left", act:true, count:1, rate:10, edit:1},
        ...
        draw: function(n) {
            ...
            var e = c.e[n]; html.txt.add(e.act, c.t.act[o.act]); if (o.edit) {html.txt.add(e.rem, "✖");}
    ...
    ini: function () {
        var t = auc.tab.e, c = auc.control; /*https://googledrive.com/host/0B0oS5SfDwtGccFBTd0hqLVNGV2c/*/
        html.h().appendChild(html.tag.get("link", {"href":"auc.css", "rel":"stylesheet", "type":"text/css"}));
        html.txt.add(t.ush, "Ultimouse 3.0"); html.txt.add(t.add, "➕"); html.txt.add(t.box, "✖"); t.ear.appendChild(t.box);
        //Options
    ...
    call: function(ev) {
        ...
        if ((!html.tag.test.root(e, auc.tab.e.wrap) || s === "add") && d) {
            var n = 0; while (n < c.o.length) {if (c.o[n].code === d+k) {c.bash(n, r); q(); break;} n++;}
            if (r && s === "add") {
                if (n === c.o.length) {c.o[n] = {code:d+k, name:c.t.name[d+k] || ev.code || d+" "+k, act:0, count:1, rate:10, edit:1}; c.draw(n);};
            ...
            if (id === "box") {auc.state(s === "open" ? "close" : "open");}
            else if (id === "add") {auc.state("add");}
            else if (id === "act") {
                c.o[n][id] = !c.o[n][id]; html.txt.set(e, c.t[id][c.o[n][id]]); c.save();
            }
            else if (id === "rem") {
...
window.onload = function(){auc.ini();};